      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12 flex flex-col md:flex-row justify-between items-center text-sm font-light text-gray-400">
        <div className="mb-6 md:mb-0 text-center md:text-left">
          <p className="font-serif italic text-lg text-white mb-2">
            "Donde la arquitectura encuentra su sombra, ahí comienza mi
            historia."
          </p>
          <p>
            &copy; {new Date().getFullYear()} Fotografía de Autor. Todos los
            derechos reservados.
          </p>
        </div>
        ...
        <div className="flex items-center space-x-6">
          ...
          {/* Divider */}
          <div className="w-px h-5 bg-white/20 mx-2 hidden" />
